# ESTA PRÁCTICA NO USA BIEN LA PILA, NO LA USES DE REFERENCIA
# ESTA PRÁCTICA NO USA BIEN LA PILA, NO LA USES DE REFERENCIA
# ESTA PRÁCTICA NO USA BIEN LA PILA, NO LA USES DE REFERENCIA
# ESTA PRÁCTICA NO USA BIEN LA PILA, NO LA USES DE REFERENCIA
# ESTA PRÁCTICA NO USA BIEN LA PILA, NO LA USES DE REFERENCIA
...
.text
	# // --- LEYENDA REGISTROS --- \\ #
	# $a0 -> Entero 1 en complemento a 2 32 bits
	# $a1 -> Entero 1 en complemento a 2 32 bits
	...
	pila_test:
		...
		# $a0 -> Número 1 que entra en pila
		# $a1 -> Tipo de transformación, 16 bits en CA2
		# $a2 -> Dirección de la cadena donde se guarda
		jal itoa
		lw $a0, 0($sp) # Segundo número como parametro de pila_test
		la $a2, string2 # Dirección donde se almacenará el segundo número convertido
		jal itoa
